        ...
        <div class="form">
            ...
            <div class="form-wrapper">
                ...
                <div class="input">
                    ...
                    <div class="form-agreement">By registering, you confirm that you agree to the storing and processing of your personal data by KiteSense as described in the <DynamicLink to="/terms-policies-master" id="form-agreement-link">Terms & Conditions.</DynamicLink>
                    </div>
