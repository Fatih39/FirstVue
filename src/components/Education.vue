...
<template>
    ...
    <div class="education-wrapper fade-in">
        ...
        <div class="education-section-2">
            <div class="education-section-2-container">
                ...
                <div class="education-stats-desc">
                    Personalised learning helps students focus on areas they need to improve in and keep them along the learning path by prescribing “What’s Next”.
                </div>
            </div>
            <div class="education-section-2-container">
                <div class="education-stats-title">Boost student confidence by 18%*</div>
                <div class="education-stats-desc">
                    Student performance is monitored in real-time and difficulty of questions is  automatically adjusted to ensure a clear path to mastery of the subject.
                </div>
            </div>
            <div class="education-section-2-container">
                <div class="education-stats-title">Improve enjoyment by 30%*</div>
                <div class="education-stats-desc">Multiple levels of intervention provide relevant support and feedback when the student needs it on their learning journey.</div>
            </div>
        </div>
        ...
        <div class="education-section-4-vector background-no-repeat-size-contain"></div>
            ...
            <div class="education-section-4-container-1">
                <div class="education-section-4-desc">
                    <div class="education-section-4-text-content">
                        <div class="education-section-4-text-content-title">Higher Students' Engagement & Enjoyment</div>
                        <div class="education-section-4-caption">Students feel more supported in the learning process with curated content customized to their ability levels. While increasing engagement, students also better enjoy the learning experience.</div>
                    </div>
                    <DynamicLink to="/contact-us"><div class="button-style-primary-education">Request Demo</div></DynamicLink>
                </div>
                <div class="education-section-4-dummy-1 background-no-repeat-size-contain"></div>
            </div>
            <div class="education-section-4-container-2">
                <div class="education-section-4-dummy-1 background-no-repeat-size-contain"></div>
                <div class="education-section-4-desc">
                    <div class="education-section-4-text-content">
                        <div class="education-section-4-text-content-title">Improve Learning Outcomes</div>
                        <div class="education-section-4-caption">By analysing students' learning data points, KiteSense can enable educators to create a customised learning journey for every student. It will empower and engage students to gain mastery in every subject.</div>
                    </div>
                    <DynamicLink to="/solution-improve-learning-outcomes"><div class="button-style-primary-education">Impact Study</div></DynamicLink>
                </div>
            </div>
        </div>

        <div class="education-section-5-cloud background-no-repeat-size-contain"></div>
        <div class="education-section-5">
            <div class="education-section-5-container-1">
                <div class="education-section-5-desc">
                    ...
                    <div class="education-section-5-desc-content">
                        Help students achieve better scores and improve knowledge retention by providing an appropriate level of challenge personalised to their abilities. Mastery.AI automatically scaffolds learning tasks, optimise learning paths, and provide the right materials at the right time for each student.
                    </div>
                </div>
                <div class="education-section-5-desc">
                    <div class="education-section-5-desc-title">
                    ...
                    <div class="education-section-5-desc-content">
                        Educators are able to provide a personalised learning experience through KiteSense with content automatically recommended to students based on their competency. Educators are able to see where students are in their learning journey, focus on weaker students and stretch advanced students during in-person instruction.
                    </div>
                </div>
            </div>
            ...
            <div class="education-section-5-container-2">
                <div class="education-section-5-desc">
                    ...
                    <div class="education-section-5-desc-content">
                        Management team can monitor metrics to evaluate instructional outcomes in real time via a comprehensive dashboard. They can easily monitor student progress, identify skill gaps in teaching staff and make adjustments to curriculum as needed.
                    </div>
                </div>
                <div class="education-section-5-desc">
                    ...
                    <div class="education-section-5-desc-content">
                        For younger learners, parents can gain access to their child's progress reports to see areas of strengths and improvements needed. This shared understanding allows them to support students learning at home.
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="education-form-title">
            Connect with Our Experts
        </div>
        <div class="education-form-caption">
            Let us show you how you can help learners create their own path to mastery at their own pace.
        </div>
        <form ref="form" @submit.prevent = "sendMail">
            <div class="education-input">
                <input type="email" class="input-form" name="email" placeholder="Your Email" id="mce-EMAIL" required autocomplete="off"
                />
...
<style src="../assets/css/Education.css">
</style>
