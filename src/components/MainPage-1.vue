...
<template>
  <div class="greetings wrapper fade-in">
    ...
    <h4>
      Kitesense’s Mastery.AI engine recommends the right learning content at the right time so learners can achieve proficiency in skills and knowledge faster.
    </h4>
