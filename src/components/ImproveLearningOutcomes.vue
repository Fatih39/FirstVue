...
<template>
    ...
    <div class="ilc-wrapper fade-in">
        ...
        <div class="ilc-section-2">
            <div class="ilc-section-2-1">
                ...
                <div class="ilc-section-2-text-content-2">
                    ...
                    <div class="ilc-section-2-text-content-content">
                        <ul>
                            <li>To accelerate literacy recovery due to Covid-19 learning loss.</li>
                            <li>An asynchronous self-directed digital reading programme using AI to recommend books based on learners’ reading ability.</li>
                            <li>Automatically streams learners into differentiated learning paths with effective learning recommendations to improve literacy level.</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="ilc-form">
                ...
                <div class="ilc-agreement">By registering, you confirm that you agree to the storing and processing of your personal data by KiteSense as described in the <DynamicLink to="/terms-policies-master" id="agreement-link">Terms & Conditions.</DynamicLink></div>
            </div>
